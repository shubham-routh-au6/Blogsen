...
class Upload extends Component {
  ...
  onSubmit = async () => {
    ...
    if (file2) {
      ...
      if (checkImage[1] !== "png" && "jpg" && "jpeg") {
        this.setState({ loading: false });
        return this.setState({
          errorMsg: "Please select an image with extension .png/.jpg/.jpeg",
        });
      }
    }
        ...
        .then((response) => {
          ...
          return axios
            ...
            .then((response) => {
              ...
              fetch("https://secret-atoll-20638.herokuapp.com/editBlog", {
                method: "post",
                headers: {
                ...
                .then((res) => {
                  ...
                  if (res.statusText === "OK") {
                    return this.setState({
                      msg:
                        "Blog updated successfully and it will appear on your dashboard",
                    });
                  }
                })
                .catch((e) => {
